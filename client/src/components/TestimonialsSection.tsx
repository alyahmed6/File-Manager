  ...
  return (
    <section className="py-16 bg-muted/50">
      <div className="container mx-auto px-4">
        ...
        {/* Main testimonials container with the requested class */}
        <div className="rounded-lg border border-primary/20 bg-card p-6 flex flex-col gap-3 shadow-sm transition-all duration-300 hover-elevate">

        {/* Grid Layout - Uses the exact class you requested */}
        <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
