...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/5 pt-4 md:pt-6 pb-12 md:pb-20 min-h-[calc(100vh-60px)] md:min-h-0 flex flex-col justify-center">
