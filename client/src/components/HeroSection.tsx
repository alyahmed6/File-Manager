...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/5 py-8 md:py-16">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-12">
          <div className="flex-1 space-y-6 text-center lg:text-left w-full max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <Link href="/register">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-accent hover:bg-accent/90 text-accent-foreground border border-accent"
          ...
          <div className="w-full max-w-2xl pt-8 border-t border-border/50">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold" data-testid="text-who-this-course">
