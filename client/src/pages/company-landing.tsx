  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-clip">
      <div className="relative flex flex-col min-h-screen" style={{ zIndex: 3 }}>
        ...
        <div className="snap-start min-h-screen min-h-[100dvh] flex flex-col py-4 md:py-8">
          <Header />
          <section
        ...
        {/* ── SERVICES ─────────────────────────────────────────────── */}
        <section
          className="relative bg-card/85 min-h-screen min-h-[100dvh] flex flex-col justify-start pt-6 pb-6 md:pt-12 md:pb-4 md:py-12 snap-start"
        ...
        {/* ── WEB3 COURSE ──────────────────────────────────────────── */}
        <section
          className="relative bg-background/85 min-h-screen min-h-[100dvh] flex flex-col justify-start pt-6 pb-6 md:pt-12 md:pb-4 md:py-12 snap-start"
          data-testid="section-course-showcase"
        >
          <div className="container mx-auto px-4 max-w-5xl">
            <motion.div
        ...
        {/* ── TESTIMONIALS ─────────────────────────────────────────── */}
        <section
          className="relative bg-card/85 min-h-screen min-h-[100dvh] flex flex-col justify-center py-6 md:py-10 md:py-12 snap-start"
      ...
      <section className="snap-start py-4 md:py-0">
        <Footer />
      </section>
      </div>
    </div>
